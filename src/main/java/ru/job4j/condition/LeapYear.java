...
/**
 * 9. Високосный год.
 * Всем нам известно такое понятие как високосный год - это год в котором в феврале по календарю 29 дней, а не 28 как во все остальные годы.
 * Чтобы определить является ли год високосным, то он должен отвечать следующим критериям
